...
for boundary in boundary_values:
    ...
    for init_position in init_position_values:
        for f_cil in fcil_values:
            for Hval1 in range(len(H1_values)):
                for Hval2 in range(len(H2_values)):
                    for Drval in range(len(Dr_values)):
                        print(Drval, Hval1, Hval2)
                        print(f"Running batch: Dr={Dr_values[Drval]}, H1={H1_values[Hval1]}, H2={H2_values[Hval2]}, CIL={f_cil}, Start={init_position}")
                        ...
                        print(f"Initializing set: Dr={Dr_values[Drval]}, H1={H1}, H2={H2}, Alpha={alpha}, Boundary={boundary}, CIL={f_cil}, Start={init_position}")
                        ...
                        for sim in range(replicates):
                            filename = f'Sim_{sim}_Dr_{Dr_str}_H1_{H1_str}_H2_{H2_str}_Alpha_{Alpha_str}_Boundary_{Boundary_str}_fcil_{fcil_str}_Start_{Start_str}.npz'
