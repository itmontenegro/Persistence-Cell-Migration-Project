...
class TrajectoryDataset(Dataset):  
    ...
    def __getitem__(self, idx):
        ...
        if path not in self.file_cache:
            ...
            # Preserving the original 7 features exactly
        ...
        # Targets limited strictly to Dr and H2
...
class DataManager:
    ...
    def _load_files(self):
        ...
        for p in all_npz:
            # We strictly search the filename itself, ignoring the rest of the folder path
    ...
    def get_loaders(self):
        ...
        for p, dr, h1, h2, alpha in self.files:
            ...
            for _ in range(350):
                all_targets.append([np.log10(dr + 1), h2])
...
def run_pipeline():
    ...
    print(" Training-TCN (7INPUTS | 2 OUTPUTS: Dr, H2)")
